...
int main() {
    ...
    std::cout << "Sanity check (Has Unreachable Symbols?) : " << factory.HasUnreachableSymbols(gr) << "\n";
    std::cout << "Sanity check (Has Direct Left Recursion?) : " << factory.HasDirectLeftRecursion(gr) << "\n";
